...
export const itemTypes: ItemType[] = [
  { id: "type_snippet", name: "Snippets", icon: "Code", color: "#3b82f6", slug: "snippets", kind: "text", isPro: false, count: 24 },
  { id: "type_prompt", name: "Prompts", icon: "Sparkles", color: "#8b5cf6", slug: "prompts", kind: "text", isPro: false, count: 18 },
  { id: "type_command", name: "Commands", icon: "Terminal", color: "#f97316", slug: "commands", kind: "text", isPro: false, count: 15 },
  { id: "type_note", name: "Notes", icon: "StickyNote", color: "#fde047", slug: "notes", kind: "text", isPro: false, count: 12 },
  { id: "type_file", name: "Files", icon: "File", color: "#6b7280", slug: "files", kind: "file", isPro: true, count: 5 },
  { id: "type_image", name: "Images", icon: "Image", color: "#ec4899", slug: "images", kind: "file", isPro: true, count: 3 },
  { id: "type_link", name: "Links", icon: "Link", color: "#10b981", slug: "links", kind: "url", isPro: false, count: 8 },
];
